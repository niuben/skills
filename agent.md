...
- **Design principles**: Dependency injection, stateless service classes in `packages/services`, pluggable persistence (`@skillsos/storage`), and clear type boundaries in `@skillsos/core`.
