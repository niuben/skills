...
- **Design principles**: Dependency injection, stateless service classes in `packages/services`, pluggable persistence (`@skillshub/storage`), and clear type boundaries in `@skillshub/core`.
